                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($tb_pembeli as $res) { ?> 
                                        <tr>
                                            ...
                                            <td>
                                            <a href="<?= site_url('beranda/edit_pembeli/'.$res->id_pembeli)?>" 
                                            class="btn btn-outline-warning btn-sm"><i class="fas fa-pen"></i>Edit</a>   
                                            <a href="<?php echo site_url('beranda/del_pembeli/'.$res->id_pembeli); ?>" class="btn btn-outline-danger btn-sm delete-btn" 
